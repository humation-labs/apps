...
export function ScreenshotGallery({ shots }: { shots: Shot[] }) {
  ...
  return (
    <div className="relative min-w-0 -mx-6 lg:-mx-10">
      <div
        ref={ref}
        className="no-scrollbar flex snap-x snap-proximity gap-4 overflow-x-auto overscroll-x-contain px-6 lg:px-10 scroll-pl-6 lg:scroll-pl-10 scroll-pr-6 lg:scroll-pr-10"
        role="region"
